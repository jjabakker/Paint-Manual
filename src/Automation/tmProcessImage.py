...
def process_image(image, roi_set):
    ...
    # -------------------------------------------------------------------------------------------------
    # Now cycle through the cell results table, calculate the Tau for acjh cell and insert in the table
    # -------------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    process_image(root_directory, roi_set)
